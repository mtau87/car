...
#ifndef CARTOGRAPHER_MAPPING_CAR_COLLATED_TRAJECTORY_BUILDER_H_
#define CARTOGRAPHER_MAPPING_CAR_COLLATED_TRAJECTORY_BUILDER_H_
...
class CarCollatedTrajectoryBuilder : public TrajectoryBuilder {
 public:
  CarCollatedTrajectoryBuilder(
  ...
  ~CarCollatedTrajectoryBuilder() override;

  CarCollatedTrajectoryBuilder(const CarCollatedTrajectoryBuilder&) = delete;
  CarCollatedTrajectoryBuilder& operator=(const CarCollatedTrajectoryBuilder&) =
      delete;
